...
ActiveRecord::Schema.define(:version => 20130823204503) do
  ...
  add_index "accounts", ["root_account_id"], :name => "index_accounts_on_root_account_id"
  add_index "accounts", ["sis_source_id", "root_account_id"], :name => "index_accounts_on_sis_source_id_and_root_account_id", :unique => true
  ...
  add_index "attachments", ["scribd_attempts"], :name => "scribd_attempts_smt_workflow_state"
  ...
  add_index "communication_channels", ["confirmation_code"], :name => "index_communication_channels_on_confirmation_code"
  ...
  add_index "content_migrations", ["context_id"], :name => "index_content_migrations_on_context_id"
  ...
  add_index "course_sections", ["root_account_id"], :name => "index_course_sections_on_root_account_id"
  add_index "course_sections", ["sis_source_id", "root_account_id"], :name => "index_course_sections_on_sis_source_id_and_root_account_id", :unique => true
  ...
  add_index "courses", ["sis_source_id", "root_account_id"], :name => "index_courses_on_sis_source_id_and_root_account_id", :unique => true
  ...
  add_index "enrollment_terms", ["root_account_id"], :name => "index_enrollment_terms_on_root_account_id"
  add_index "enrollment_terms", ["sis_source_id", "root_account_id"], :name => "index_enrollment_terms_on_sis_source_id_and_root_account_id", :unique => true
  ...
  add_index "groups", ["sis_source_id", "root_account_id"], :name => "index_groups_on_sis_source_id_and_root_account_id", :unique => true
  ...
  add_index "pseudonyms", ["account_id"], :name => "index_pseudonyms_on_account_id"
  ...
  add_index "pseudonyms", ["sis_user_id", "account_id"], :name => "index_pseudonyms_on_sis_user_id_and_account_id", :unique => true
  add_index "pseudonyms", ["user_id"], :name => "index_pseudonyms_on_user_id"
  add_index "pseudonyms", [nil, "account_id"], :name => "index_pseudonyms_on_unique_id_and_account_id", :unique => true
